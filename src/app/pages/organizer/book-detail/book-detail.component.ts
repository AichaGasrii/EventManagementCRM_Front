...
export class BookDetailComponent implements OnInit {
  ...
  constructor(private _route:ActivatedRoute,private bookingService:AdminBookingServiceService,    private router: Router
  ) { }
  ...
  planEvent(bookingId: number): void {
    this.router.navigate(['/organizer/taskPlanning', bookingId]);
  }
}
